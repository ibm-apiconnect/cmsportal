...
namespace Drupal\ibm_apim\entity;
...
/**
 * Class ApicEntityDefinitionUpdateManager
 *
 * Apic Entity Definition Update Manager
 * Customized class from the Devel Entity Updates module
 * Development version of the entity definition update manager.
 *
 * @package Drupal\ibm_apim\entity
 */
final class ApicEntityDefinitionUpdateManager implements ContainerInjectionInterface {
   ...
   * {@inheritdoc}
   */
  public static function create(ContainerInterface $container): ApicEntityDefinitionUpdateManager {
    /** @noinspection PhpParamsInspection */
    return new ApicEntityDefinitionUpdateManager(
   ...
   * @throws \Drupal\Component\Plugin\Exception\PluginNotFoundException
   */
  private function doEntityUpdate($op, $entity_type_id): void {
